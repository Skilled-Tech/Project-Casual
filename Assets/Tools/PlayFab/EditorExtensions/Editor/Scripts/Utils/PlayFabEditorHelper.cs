...
namespace PlayFab.PfEditor
{
    ...
    public static partial class PlayFabEditorHelper
    {
        ...
        public static string EDEX_NAME = "EditorExtensions";
        public static string EDEX_ROOT = Application.dataPath + "/Tools/PlayFab/EditorExtensions/Editor";
        ...
        public static string DEFAULT_SDK_LOCATION = "Assets/Tools/PlayFab/SDK";
