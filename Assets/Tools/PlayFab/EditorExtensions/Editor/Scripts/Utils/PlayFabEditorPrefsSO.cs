    ...
    public class PlayFabEditorPrefsSO : ScriptableObject
    {
        ...
        public static PlayFabEditorPrefsSO Instance
        {
            get
            {
                ...
                if (!Directory.Exists(Path.Combine(Application.dataPath, "Tools/PlayFab/EditorExtensions/Editor/Resources")))
                    Directory.CreateDirectory(Path.Combine(Application.dataPath, "Tools/PlayFab/EditorExtensions/Editor/Resources"));
                ...
                AssetDatabase.CreateAsset(_instance, "Assets/Tools/PlayFab/EditorExtensions/Editor/Resources/PlayFabEditorPrefsSO.asset");
